...
namespace Microsoft.Azure.WebJobs.Script.Diagnostics.Extensions
{
    ...
    {
        private static readonly Action<ILogger, string, string, Exception> _assemblyDynamicluResolved =
        ...
        private static readonly Action<ILogger, string, string, Exception> _assemblyDynamicluResolutionFailure =
        ...
        {
            _assemblyDynamicluResolved(logger, assemblyName, functionName, null);
        }

        public static void AssemblyDynamiclyResolutionFailure(this ILogger logger, string assemblyName, string functionName)
        {
            _assemblyDynamicluResolutionFailure(logger, assemblyName, functionName, null);
        }
